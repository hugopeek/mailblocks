...
$data['build']['readme'] = 'core/components/mailblocks/' . $data['build']['readme'];
$data['build']['license'] = 'core/components/mailblocks/' . $data['build']['license'];
$data['build']['changelog'] = 'core/components/mailblocks/' . $data['build']['changelog'];
